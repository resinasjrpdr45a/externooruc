$(document).ready(function(){
    ...
    if (window.matchMedia('(max-width: 657px)').matches){  
      ...
      $(window).scroll(function(){
		...
		//Ajuste da Barra de Buscas na Resolução de 635px
		if (window.matchMedia('(max-width: 635px)').matches){  
            ...
            $('#header-search').css({"margin-top":"132px"});
    			}
		...
		//Ajuste da Barra de Buscas na Resolução de 590px
		if (window.matchMedia('(max-width: 590px)').matches){  
			...
			$(window).scroll(function(){
    			...
    			if(topo<151){
    				...
    				$('#header-search').css({"margin-top":"125px"});
    			}
		...
		//Ajuste da Barra de Buscas na Resolução de 580px
		if (window.matchMedia('(max-width: 580px)').matches){  
			...
			$(window).scroll(function(){
    			...
    			if(topo<151){
  					$('.wbc-mainnav').css({"margin-top":"50px"});  
            $('#header-search').css({"margin-top":"124px"});
    			}
    ...
    if (window.matchMedia('(max-width: 520px)').matches){  
      ...
      $(window).scroll(function(){
          ...
          //Referente a Barra Estatica
          if(topo<151){
            $('.wbc-mainnav').css({"margin-top":"135px"});  
            $('#header-search').css({"margin-top":"150px"});
          }
		...
		if (window.matchMedia('(max-width: 497px)').matches){  
			...
			$(window).scroll(function(){
    			...
    			if(topo<151){
  					$('.wbc-mainnav').css({"margin-top":"128px"});  
            $('#header-search').css({"margin-top":"144px"});
    			}
    ...
    if (window.matchMedia('(max-width: 635px)').matches){  
      ...
      $(window).scroll(function(){
          ...
          if(topo<151){
            $('.wbc-mainnav').css({"margin-top":"60px"});  
            $('#header-search').css({"margin-top":"133px"});
          }
