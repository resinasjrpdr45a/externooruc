...
$('.footer-middle .space-bottom-5 .col-lg-4,.col-md-4,.col-sm-4,.col-xs-12 hidden-xs').addClass("creditcopy");
$('.creditcopy').removeClass("col-lg-4 col-md-4 col-sm-4 col-xs-12 hidden-xs "); 

$('.footer-middle .col-lg-3:nth-child(4),.col-md-3:nth-child(4),.col-sm-12:nth-child(4),.col-xs-12:nth-child(4)').css({"display":"none"});
   ...
   $('.text-center').removeClass("col-xs-4 col- col-sm-12 col-md-5");

$('.col-newsletter').removeClass( "col-lg-6 col-md-6 col-sm-6 col-xs-12" );
   $('.col-news').removeClass("col-lg-6 col-md-6 col-sm-6 col-xs-12");
   $('#form_whatsapp .block_content:nth-child(1)').removeClass("col-xs-12sm-4 col-md-3 pull-left");  
   $('.footer-middle .payment').removeClass("pull-left");
